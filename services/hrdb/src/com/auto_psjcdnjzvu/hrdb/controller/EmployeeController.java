...
import com.auto_psjcdnjzvu.hrdb.Vacation;
import com.auto_psjcdnjzvu.hrdb.service.EmployeeService;
...
public class EmployeeController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportEmployeesAndGetURL(@RequestBody ExportOptions options, @RequestParam(value = "exportSize", required = false) Integer exportSize, Pageable pageable) {
