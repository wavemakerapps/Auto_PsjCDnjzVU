...
import com.auto_psjcdnjzvu.hrdb.service.VacationService;
...
public class VacationController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportVacationsAndGetURL(@RequestBody ExportOptions options, @RequestParam(value = "exportSize", required = false) Integer exportSize, Pageable pageable) {
