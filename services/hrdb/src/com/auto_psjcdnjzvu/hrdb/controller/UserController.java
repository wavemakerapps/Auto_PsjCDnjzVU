...
import com.auto_psjcdnjzvu.hrdb.User;
import com.auto_psjcdnjzvu.hrdb.service.UserService;
...
public class UserController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportUsersAndGetURL(@RequestBody ExportOptions options, @RequestParam(value = "exportSize", required = false) Integer exportSize, Pageable pageable) {
